...
class __Mustache_b1eac26f42434da3a17be7a2cf2b0ec3 extends Mustache_Template
{
...
';
        $buffer .= $indent . '            <img class="w-25 mb-4" alt="" aria-hidden="true" src="';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <div class="alert alert-warning w-75 mx-auto mb-3" role="alert">
';
        $buffer .= $indent . '                <strong>';
        $value = $context->find('str');
        $buffer .= $this->section96bcf8f64f1059cf3c42872344628a3f($context, $indent, $value);
        $buffer .= '</strong>
';
        $buffer .= $indent . '                <p class="mb-1">';
        $value = $context->find('str');
        $buffer .= $this->sectionD2d23c0eddbc8f913a16d03a3471fc86($context, $indent, $value);
        $buffer .= '</p>
';
        $buffer .= $indent . '                <p class="mb-0">';
        $value = $context->find('str');
        $buffer .= $this->section34c454bb512256f579a4a0c48cbe87b4($context, $indent, $value);
        $buffer .= '</p>
';
        $buffer .= $indent . '            </div>
';
...
';
    ...
    private function section96bcf8f64f1059cf3c42872344628a3f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'removalwarning_title, tool_moodlenet';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
            foreach ($values as $value) {
                ...
                $buffer .= 'removalwarning_title, tool_moodlenet';
                $context->pop();
            }
        }
    ...
    private function sectionD2d23c0eddbc8f913a16d03a3471fc86(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'removalwarning_service, tool_moodlenet';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
            foreach ($values as $value) {
                ...
                $buffer .= 'removalwarning_service, tool_moodlenet';
                $context->pop();
            }
        }
    ...
    private function section34c454bb512256f579a4a0c48cbe87b4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'removalwarning_feature, tool_moodlenet';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
            foreach ($values as $value) {
                ...
                $buffer .= 'removalwarning_feature, tool_moodlenet';
                $context->pop();
            }
        }
