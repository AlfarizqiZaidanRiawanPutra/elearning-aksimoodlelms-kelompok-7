...
$string['clistatusenabledlater'] = 'Status: Mode pemeliharaan Antarmuka Baris Perintah (CLI) akan diaktifkan pada {$a}';
...
$string['cliupgradesetlock'] = 'Pemutakhiran telah dikunci hanya untuk eksekusi Antarmuka Baris Perintah (CLI).';
$string['cliupgradeunsetlock'] = 'Kunci pemutakhiran eksekusi Antarmuka Baris Perintah (CLI) yang ada telah dihapus.';
...
$string['configdebugdisplay'] = 'Jika diaktifkan, pesan awakutu ditampilkan di halaman HTML. Ini merusak XHTML, JavaScript, cookie, dan header HTTP secara umum. Jika tidak, pesan awakutu disimpan di log server, sehingga memungkinkan proses awakutu lebih baik. Pengaturan PHP error_log mengontrol log mana yang dituju.';
...
$string['configmailnewline'] = 'Menyetel format akhir baris untuk surat keluar. Meskipun standar surel universal RFC 822bis memerlukan Carriage Return Line Feed (CRLF), cara server email memproses karakter ini berbeda-beda. Beberapa secara otomatis memperbaiki akhiran Umpan Baris (LF) sederhana, sementara yang lain salah membuat baris spasi ganda (CRCRLF) atau menolak surel dengan LF kosong. Ubah setelan ini jika Anda memiliki masalah dengan surel tidak terkirim atau baris baru ganda.';
...
$string['configpathtophp'] = 'Jalur ke Antarmuka Baris Perintah PHP (CLI). Biasanya /usr/bin/php atau serupa. Jika Anda memasukkan ini, skrip cron dapat dijalankan dari antarmuka web admin.';
...
$string['configsmtphosts'] = 'Berikan nama lengkap dari satu atau lebih server SMTP lokal yang harus digunakan Moodle untuk mengirim surel (misalnya \'mail.a.com\' atau \'mail.a.com;mail.b.com\'). Untuk menentukan porta non-bawaan (yaitu selain porta 25), gunakan sintaksis [server]:[port] (misalnya \'mail.a.com:587\'). Untuk koneksi aman, porta 465 biasanya digunakan dengan SSL, porta 587 biasanya digunakan dengan Transport Layer Security (TLS). Tentukan protokol keamanan di bawah ini jika diperlukan. Jika Anda membiarkan kolom ini kosong, Moodle akan menggunakan metode pengiriman surel bawaan PHP.';
...
$string['configsmtpoauthservice'] = 'Pilih layanan OAuth 2 yang dikonfigurasi untuk berkomunikasi dengan server SMTP. Jika layanan belum ada, Anda harus membuatnya. Perhatikan bahwa Anda perlu menyetel jenis autentikasi SMTP ke XOAUTH2.';
...
$string['curlcache'] = 'cache cURL  Time-to-Live (TTL)';
...
$string['emaildkiminfo'] = 'Jika pemilih DKIM disetel dan file sertifikat pribadi ditemukan yang cocok dengan domain alamat "Dari" surel di $CFG->dataroot/dkim/[domain]/[selector].private maka surel akan ditandatangani. Dalam sebagian besar kasus (misalnya jika domain surel yang diizinkan kosong) hanya satu sertifikat yang diperlukan di <pre>{$a->path</pre> Untuk detail penyiapan lebih lanjut, lihat dokumentasi <a href="{$a->docs}">Konfigurasi surel</a>.';
...
$string['geoipfile'] = 'Basis data Kota GeoIP';
...
$string['maxtimelimit_desc'] = 'Untuk membatasi waktu eksekusi PHP maksimum yang diperbolehkan Moodle tanpa menampilkan output apa pun, masukkan nilai dalam hitungan detik di sini. 0 berarti pembatasan bawaan Moodle digunakan. Jika Anda memiliki server front-end dengan batas waktunya sendiri, tetapkan nilai ini lebih rendah untuk menerima kesalahan PHP dalam log. Tidak berlaku untuk skrip Command Line Interface (CLI).';
